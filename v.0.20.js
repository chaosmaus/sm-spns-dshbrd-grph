...
$(async function () {
    ...
    const initiateGraph = async (data) => {
        ...
        $('.dashboard--graph--label').eq(0).text('$' + baseValueTop + 'M');
        $('.dashboard--graph--label').eq(1).text('$' + twoThirdsValueTop + 'M');
        $('.dashboard--graph--label').eq(2).text('$' + oneThirdValueTop + 'M');
        //bottom
        $('.dashboard--graph--label').eq(4).text('$-' + oneThirdValueBottom + 'M');
        $('.dashboard--graph--label').eq(5).text('$-' + twoThirdsValueBottom + 'M');
        $('.dashboard--graph--label').eq(6).text('$-' + baseValueBottom + 'M');
        ...
        $('.dgraph--index--text').on('click', function () {
            ...
            if ($this.data('clicked')) {
                ...
                if($this.attr('id') === 'surplus_and_investment_income')$('#surplus_and_investment_income').css('color', 'rgba(121, 102, 204, .75)')
            }
        });
