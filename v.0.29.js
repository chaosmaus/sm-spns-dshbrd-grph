    ...
    const getModel = async (estimatedClaims = null, annualPremium = null) => {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#operational_fees_and_expenses').text(Number(response.responseData.model.opex_percentage_of_premium) + Number(response.responseData.model.admin_fees_percentage_of_premium) * 100 + '%')
